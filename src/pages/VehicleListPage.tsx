        ...
        <div className="p-8 min-h-screen bg-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {vehicles.map(vehicle => (
                    ...
                    >
                        <div
                            className="font-bold text-lg mb-1 text-gray-900">{vehicle.make} {vehicle.model}
                        ...
                        <div>Plate: <span
                            className="font-mono text-gray-700">{vehicle.licensePlate}</span></div>
                        <div>Mileage: <span
                            className="font-semibold text-blue-700">{vehicle.mileage.toLocaleString()}</span> km
                        </div>
                        <div className="mt-2">
                            <span
